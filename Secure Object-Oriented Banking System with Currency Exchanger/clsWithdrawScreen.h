...
public:
	...
	static void UpdateClienBalanceWithdrawInfo()
	{
		...
		float DepoistAmount = clsInputValidation::ReaddoubleNumber("Please Enter Withdraw Amount :");
		...
		if (toupper(Answer) == 'Y')
		{
			if (Client.Withdraw(DepoistAmount))
			{
			...
			else
			{
				...
				cout << "Amount To Withdraw : {" << Client.Balance << "}";
